function alertMsg(msg, mode) { //mode为空，即只有一个确认按钮，mode为1时有确认和取消两个按钮
    ...
    //遮罩层
    var styleStr = 'top:0;left:0;position:absolute;z-index:10000;background:#61C4DD;width:' + winSize.pageWidth + 'px;height:' +  (winSize.pageHeight + 30) + 'px;';
    styleStr += (isIe) ? "filter:alpha(opacity=80);" : "opacity:0.3;"; //遮罩层DIV
    ...
    if (mode === 1) {
        ...
        btn2.innerHTML = '<cite>Consel</cite>';
